...
export default function Card(props) {
  ...
  return (
    <div>
      <div className="card mt-3" style={{ width: "18rem", maxHeight: "360px", objectFit: "contain" }}>
        <img src={props.foodItem.img} className="card-img-top" alt="..." style={{height:"170px", objectFit:"fill"}} />
        <div className="card-body">
          <h5 className="card-title">{props.foodItem.name}</h5>
          <div className="container w-100">
            <select className="m-2 h-100 btn-success rounded" onChange={(e) => setQty(e.target.value)}>
